"""
 Major part of this module is copied from tensorflow's official nlp library (tf-models-official),
 due to incompatibilities when importing TF2 version hierarchy with other older libraries
"""
...
def create_tokenizer_from_hub_module(model_handle):
    """Get the vocab file and casing info from the Hub module."""
    with tf.Graph().as_default():
        bert_module = hub.Module(model_handle)
...
class BasicTokenizer(object):
    ...
    Args:
      ...
      split_on_punc: Whether to apply split on punctuations. By default BERT
        starts a new token for punctuations. This makes de-tokenization difficult
